namespace CNET_ERP_V7.WebConstants
{
    public static class CNET_WebConstantes
    {
        ...
        public const int ASSEBLY_PACKIING_VOUCHER = 294;
        public const int DISASSEBLY_PACKIING_VOUCHER = 295;
        ...
        #region project mangement definitions
        public const int CHANGE_LOG_VOUCHER = 321;
        public const int DAILY_TIME_SHEET_VOUCHER = 322;
        public const int JOB_ORDER_VOUCHER = 323;
        public const int PROJECT_QUALITY_CHECK = 324;
        public const int PROJECT_REPORT_VOUCHER = 325;
        public const int PROJECT_VOUCHER = 326;
        public const int RISK_REGISTER_VOUCHER = 327;
        public const int TASK_FOLLOW_UP_VOUCHER = 328;
        public const int TASK_ISSUE_VOUCHER = 329;
        public const int TASK_REPORT_VOUCHER = 330;
        public const int TASK_VOUCHER = 331;
        public const int LANDEDCOST_VOUCHER = 302;
        public const int USER_ACCEPTANCE_VOUCHER = 332;
        public const int PROJECT_MONITOR = 3181;
        public const int PROJECT_PLANNER = 3182;
        ...
        public const int WITHOLDING_30 = 11;
        ...
        public const int RAW_MATERIAL_PRODUCTION_VARIATION_VOUCHER = 290;
        public const int VARIATION = 275;
        public const int PACKINGLIST = 276;
        public const int BATCH = 271;
        public const int EXTRACTION_BACH = 288;
        public const int ECOMERCE_ORDER_VOUCHER = 126;
        public const int LOCAL_PURCHASE_ORDER_VOUCHER = 303;
        public const int SUPLIER_GOODS_INVOICE_VOUCHER = 307;
        public const int PALLET = 3165;
        public const int PROFORMA_VOUCHER = 116;
        public const int Credit_Note_Invoice_Voucher = 127;
        public const int Debit_Note_Invoice_Voucher = 128;
        #endregion

        #region Formulation Types
        public const int ALTERNATE_FORMULATION_ONE = 2029;
        public const int FB_FORMULATION = 2030;
        public const int ALTERNATE_FORMULATION_TWO = 2031;
        public const int PRODUCTION_FORMULATION = 2032;
        public const int RESEARCH_FORMULATION = 2033;
        public const int EXTRACTION_FORMULATION_TYPE = 3165;
        public const int RESERVED_FORMULATION_TYPE = 3166;
        ...
        public const int ACTIVITY_DEFINATION_BULKPRICEEDIT = 3221;
        public const int ACTIVITY_DEFINATION_GRNBASEDBULKPRICE= 3222;
        ...
        public const int Value_Factor_Type = 2073;
        ...
        public const int SUB_COUNTRY_TYPE_Business_City = 1929;
        public const int SUB_COUNTRY_TYPE_Capital_City = 1930;
        public const int SUB_COUNTRY_TYPE_Kebele = 1931;
        public const int SUB_COUNTRY_TYPE_Major_City = 1932;
        public const int SUB_COUNTRY_TYPE_Province = 1933;
        public const int SUB_COUNTRY_TYPE_Regions = 1934;
        public const int SUB_COUNTRY_TYPE_State = 1935;
        public const int SUB_COUNTRY_TYPE_Subcities = 1936;
        public const int SUB_COUNTRY_TYPE_Town = 1937;
        public const int SUB_COUNTRY_TYPE_Villages = 1938;
        public const int SUB_COUNTRY_TYPE_Woreda = 1939;
        public const int SUB_COUNTRY_TYPE_Zone = 1940;
        ...
        public const int CREDITSALES_Adjustment = 111;
        ...
        public const int CASH_GOODS_RECEIVING_VOUCHER = 141;
        public const int CREDIT_GOODS_RECEIVING_VOUCHER = 143;
        public const int IMPORTED_GOODS_RECEIVING_VOUCHER = 153;
        public const int INTERNAL_GOODS_RECEIVING_VOUCHER = 155;
        ...
        public const int GSL_TRAILER = 63;
        public const int GSL_TRUCK = 64;
        public const int GSL_Member = 41;
        ...
        public static int EMV_QR = 91416; //no   
        public static int Kifiya_Micro_Credit = 70749; //no   
        ...
        public static int GSL_SUPLIER = 29;
        ...
        public const string Access_Log_Statistics = "Access Log Statistics";
        public const string Subscription_Aging = "Subscription Aging";
        #endregion

        public static int PRICE_DESCRIPTION_SELF = 3185;
        public static int PRICE_DESCRIPTION_DELIVERY = 3186;
        public static int SECRTE_RECIPE_TYPE = 3202;
        public static int ProfitMargin = 1960;
        public static int EstimatedWastage = 3216;

        public const int DASHBOARD_REPORT_1 = 645;
        public const int DASHBOARD_REPORT_2 = 646;
        public const int DASHBOARD_REPORT_3 = 647;
        public const int DASHBOARD_REPORT_4 = 648;
        public const int DASHBOARD_REPORT_5 = 649;
        public const int DASHBOARD_REPORT_6 = 650;
        public const int DASHBOARD_REPORT_7 = 651;
        public const int DASHBOARD_REPORT_8 = 652;
        public const int DASHBOARD_REPORT_9 = 653;
        public const int DASHBOARD_REPORT_10 = 654;
